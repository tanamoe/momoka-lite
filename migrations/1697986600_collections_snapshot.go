		...
		jsonData := `[
			{
				...
				"updated": "2023-10-22 10:41:46.725Z",
				"name": "users",
				"type": "auth",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2023-10-22 10:41:46.724Z",
				"name": "formats",
				"type": "base",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2023-10-22 14:50:03.393Z",
				"name": "bookDetails",
				"type": "view",
				"system": false,
				"schema": [
				...
				"deleteRule": null,
				"options": {
					"query": "SELECT \n  books.id,\n  books.publishDate,\n  books.edition,\n  books.price,\n  books.note,\n  \"{}\" as metadata,\n  publications.id as publication,\n  publications.release,\n  \"publications\" as coversCollection,\n  publications.id as coversRecord,\n  publications.covers\nFROM books\nLEFT JOIN publications ON books.publication = publications.id\nWHERE books.covers = \"[]\"\nUNION ALL\nSELECT\n  books.id,\n  books.publishDate,\n  books.edition,\n  books.price,\n  books.note,\n  \"{}\" as metadata,\n  publications.id as publication,\n  publications.release,\n  \"books\" as coversCollection,\n  books.id as coversRecord,\n  books.covers\nFROM books\nLEFT JOIN publications ON books.publication = publications.id\nWHERE books.covers != \"[]\""
				}
			},
			{
				"id": "6uk141b1jx0dkhu",
			...
			},
			{
				...
				"updated": "2023-10-22 10:41:46.738Z",
				"name": "titleCovers",
				"type": "view",
				"system": false,
				"schema": [
