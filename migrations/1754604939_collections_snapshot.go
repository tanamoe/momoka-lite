	...
	m.Register(func(app core.App) error {
		jsonData := `[
			...
			},
			{
				...
				"id": "pbc_2099110612",
				"indexes": [
					"CREATE INDEX ` + "`" + `idx_8W3YYcO3Tn` + "`" + ` ON ` + "`" + `vote` + "`" + ` (` + "`" + `category` + "`" + `)",
					"CREATE UNIQUE INDEX ` + "`" + `idx_GXjByZ7rIp` + "`" + ` ON ` + "`" + `vote` + "`" + ` (\n  ` + "`" + `category` + "`" + `,\n  ` + "`" + `bucketId` + "`" + `,\n  ` + "`" + `user` + "`" + `\n)",
					"CREATE INDEX ` + "`" + `idx_sArLweKDcR` + "`" + ` ON ` + "`" + `vote` + "`" + ` (\n  ` + "`" + `category` + "`" + `,\n  ` + "`" + `user` + "`" + `\n)"
				],
				"listRule": null,
				"name": "vote",
				"system": false,
			...
			},
			{
				...
				"id": "pbc_1378105104",
				"indexes": [
					"CREATE INDEX ` + "`" + `idx_nwEZrG00ji` + "`" + ` ON ` + "`" + `voteCollectionItems` + "`" + ` (` + "`" + `collection` + "`" + `)",
					"CREATE UNIQUE INDEX ` + "`" + `idx_1JVHmUR86I` + "`" + ` ON ` + "`" + `voteCollectionItems` + "`" + ` (\n  ` + "`" + `collection` + "`" + `,\n  ` + "`" + `title` + "`" + `\n)"
				],
				"listRule": null,
				"name": "voteCollectionItems",
				"system": false,
				"type": "base",
				"updateRule": null,
				"viewRule": null
